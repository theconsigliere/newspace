...
$id = 'ns-parallax-' . $block['id'];
if( !empty($block['anchor']) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'ns-parallax';
...
<section class="full-width-section <?php echo esc_attr($className); ?>" id="<?php echo esc_attr($id); ?>" data-block='<?php echo esc_attr($className); ?>'>
    ...
    <!-- <div class="ns-p-svg-pattern">
      <?php //echo file_get_contents( get_stylesheet_directory_uri() . '/build/images/circle-pattern.svg' ); ?> 
    </div> -->



    <div class="ns-parallax-img with-parallax">
    ...
    <div class="ns-p-text-inner">
        ...
        <?php 
                ...
                if( $button ): 
                    ...
                    ?>
        <a class="text-button-black" href="<?php echo esc_url( $button_url ); ?>"
